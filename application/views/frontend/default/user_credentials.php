    ...
    <div class="container">
        <div class="row">
                ...
                <div class="user-dashboard-sidebar box-shadow-5">
                    ...
                    <div class="user-dashboard-menu">
                        <ul>
                            ...
                            <li class="active mb-3"><a href="<?php echo site_url('home/profile/user_credentials'); ?>">
                                    <i class="fas fa-lock"></i> <?php echo site_phrase('account'); ?></a></li>
            ...
            <div class="col-md-8 col-lg-9 mt-4 mt-md-0">
                ...
                <form class="w-100 bg-white radius-10 p-4 box-shadow-5"
                    ...
                    <div class="row">
                        ...
                        <div class="col-12 pt-4">
                            <button
                                class="btn red px-5 py-2 radius-8"><?php echo site_phrase('save_changes'); ?></button>
                        </div>
                    </div>
                </form>
            </div>
