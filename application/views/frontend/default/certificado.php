<section>
    <div class="container-xl">
        <div class="course-carousel-title text-center mb-4 mt-5 ">
            <p class="text-section">¡Verifica tus Certificados!</p>
            <p class="text-sub-cat color-text"> Buscar por documento de identidad</p>
        </div>

        <div class="d-flex flex-row mb-5 justify-content-center">
            <div class="p-1 color-text fw-600">Número de documeto de identidad:</div>
            <div class="px-5">
