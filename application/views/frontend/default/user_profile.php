    ...
    <div class="container">
        <div class="row">
            ...
            <div class="col-md-8 col-lg-9 mt-4 mt-md-0">
                <div class="user-dashboard-sidebar box-shadow-5" style="background-color: #373737;">
                    <div class="d-flex flex-row align-items-center">
                        ...
                        <div class="img-perfil">
                            <div class="p-2"> <img class="img-perfilw"
                                    src="<?=base_url()?>uploads\system\logo-perfil.png" alt=""></div>
                ...
                <form class="w-99  " action="<?php echo site_url('home/update_profile/update_basics'); ?>"
                    method="post">
                    <div class="row">
                        ...
                        <div class="col-md-6  p-2">
                            ...
                            <div class="d-flex flex-row justify-content-between">
                                <div class=""><label class="text-white fw-600"
                                        for="FristName"><?php echo site_phrase('Correo:'); ?></label></div>

                                <div class=""><a data-bs-toggle="modal" class="style-cc" href="#mcc"> <label
                                            class="text-cc" for=" ">Cambiar
                                            correo </label> </a></div>

                                <div class="modal fade" id="mcc" data-bs-backdrop="static" data-bs-keyboard="false"
                                    ...
                                    <div class="modal-dialog">
                                        <div class="modal-content modal-correo">
                                            ...
                                            <div class="d-flex flex-column  p-correoxy">
                                                ...
                                                <div class="d-flex flex-row  align-items-center">
                                                    <p style="width: 70%;" class="text-mcorreo d-flex ">Dirección de
                                                        correo actual: </p>
                                                    <input type="email" class="form-control form-correo" name="email"
                                                        id="email" value="<?php echo $user_details['email']; ?>"
                                                        disabled>
                                                </div>
                                            </div>
                                            <div class="modal-body modal-boddy">
                                                ...
                                                <div class=""><label class="text-white fw-600"
                                                        for="FristName"><?php echo site_phrase('Nueva direccion de correo'); ?></label>
                                                </div>
                                                <div class="input-group">
                                                    <input type="email" class="form-control" name="email" id="email"
                                                        placeholder="Ingrese Nueva Direccion de Correo"
                                                        value="<?php echo $user_details['nueva-direccion-correo']; ?>">
                                                </div>
                                                <div class=""><label class="text-white fw-600"
                                                        for="FristName"><?php echo site_phrase('Repita la nueva dirección de correo'); ?></label>
                                                </div>
                                                <div class="input-group">
                                                    <input type="email" class="form-control" name="email" id="email"
                                                        placeholder="Ingrese Nueva Direccion de Correo"
                                                ...
                                                <div><label class="text-white fw-600"
                                                        for="current_password"><?php echo site_phrase('Confirmar contraseña'); ?></label>
                                                </div>
                                                <div class="input-group">
                                                    <span class="input-group-text"><i
                                                            class="fas fa-key text-white"></i></span>
                                                    <input type="password" class="form-control" id="current_password"
                                                        name="current_password" placeholder="Ingrese contraseña">
                                                </div>
                                            </div>
                        ...
                        <div class="col-md-6 text-white p-2">
                            <div class="d-flex flex-row justify-content-between">
                                <div class=""> <label class="text-white fw-600"
                                        for="FristName"><?php echo site_phrase('Contraseña:'); ?></label></div>

                                <div class=""><a data-bs-toggle="modal" class="style-cc" href="#mcco"> <label
                                            class="text-cc" for=" ">Cambiar
                                            Contraseña </label> </a></div>

                                <div class="modal fade" id="mcco" data-bs-backdrop="static" data-bs-keyboard="false"
                                    tabindex="-1" aria-labelledby="staticBackdropLabel" aria-hidden="true">
                                    <div class="modal-dialog">
                                        <div class="modal-content modal-correo">
                                            <div class="modal-header">
                                            ...
                                            <div class=" p-correoxy">
                                                ...
                                                <label class=" fw-600"
                                                    for="current_password "><?php echo site_phrase('Contraseña actual'); ?></label>
                                                <div class="input-group">
                                                    <span class="input-group-text"><i class="fas fa-key"></i></span>
                                                    <input type="password" class="form-control" id="current_password"
                                                        name="current_password"
                                                        placeholder="<?php echo site_phrase('Introducir Contraseña actual'); ?>">
                                                </div>

                                                <label class=" fw-600"
                                                    for="new_password"><?php echo site_phrase('Nueva contraseña'); ?></label>
                                                <div class="input-group">
                                                    <span class="input-group-text"><i class="fas fa-lock"></i></span>
                                                    <input type="password" class="form-control" id="new_password"
                                                        name="new_password"
                                                        placeholder="<?php echo site_phrase('Ingrese la nueva contraseña'); ?>">
                                                </div>

                                                <label class=" fw-600"
                                                    for="confirm_password"><?php echo site_phrase('Confirma contraseña'); ?></label>
                                                <div class="input-group">
                                                    <span class="input-group-text"><i class="fas fa-lock"></i></span>
                                                    <input type="password" class="form-control" id="confirm_password"
                                                        name="confirm_password"
                                                        placeholder="<?php echo site_phrase('Repita la nueva contraseña'); ?>">
                                                </div>
                                            </div>
                                            <div class="modal-footer">
                        ...
                        <div class="col-md-6 text-white p-2">
                            <label class="text-white fw-600"
                                for="FristName"><?php echo site_phrase('Mi Nombre:'); ?></label>
                            <div class="input-group">
                        ...
                        <div class="col-md-6 p-2">
                            <label class="text-white fw-600"
                                for="FristName"><?php echo site_phrase('Mi Apellido:'); ?></label>
                            <div class="input-group">
                        ...
                        <div class="col-md-6 p-2">
                            <label class="text-white fw-600"
                                for="FristName"><?php echo site_phrase('Número de DNI - Cédula de Identidad:'); ?></label>
                            <div class="input-group">
                        ...
                        <div class="col-md-6 p-2">
                            <label for="validationCustom04"
                                class="text-white fw-600"><?php echo site_phrase('pais_procedencia:'); ?></label>


                            <select class="form-select style-ce " id="validationCustom04" required>
                        ...
                        <div class="col-md-6  p-2">
                            <label class="text-white fw-600"
                                for="FristName"><?php echo site_phrase('Ciudad:'); ?></label>
                            <div class="input-group">
                        ...
                        <div class="col-md-6 p-2">
                            <label class="text-white fw-600"
                                for="FristName"><?php echo site_phrase('Cel/WhatsApp'); ?></label>
                            <div class="input-group">
                        ...
                        <div class="col-md-6  p-2">
                            <form class="w-100  radius-10 p-4 box-shadow-5"
                                action="<?php echo site_url('home/update_profile'); ?>" enctype="multipart/form-data"
                                method="post">
                                <div class="row pt-3">
                        ...
                        <div class="col-md-6 p-2">
                            ...
                            <div class="input-group">
                                ...
                                <select class="form-select style-ce" aria-label="Default select example">
                        ...
                        <div class="col-12 pt-4 d-flex flex-row-reverse">
                            <button
                                class="btn bg-gc px-5 py-2 radius-8"><?php echo site_phrase('Guardar Cambios'); ?></button>
                        </div>
