            ...
            <div class="p-2">
                <div class="d-flex flex-column ">
                    ...
                    <div class="d-flex flex-column  fondo-plan-bottom">
                        ...
                        <div class="m-auto"> <a class="qsp-plan" href="">Quiero ser <span> </span> Premium</a></div>
                    </div>
            ...
            <div class="p-2">
                <div class="d-flex flex-column ">
                    ...
                    <div class="d-flex flex-column  fondo-plan-bottom">
                        ...
                        <div class="mx-auto my-3"> <a class="qsp-plan" href="">Quiero ser <span> </span> Premium</a>
                        </div>
                    </div>
    ...
    <div class="row">
        <div class="d-flex flex-column mb-3">
            ...
            <div class="d-flex flex-row mb-3 justify-content-between bg-item">
                ...
                <div class=" bg-subitem d-flex align-items-center">Si</div>
                <div class=" bg-subitem d-flex align-items-center bg-radius-subitem">Si</div>
            </div>
