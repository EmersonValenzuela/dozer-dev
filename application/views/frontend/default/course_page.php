                ...
                <div class="course-sidebar box-shadow-5 natural cuadro-contenido">
                    ...
                    <div class="course-sidebar-text-box">
                        ...
                        <div class="includes">
                            ...
                            <ul>
                                <?php if ($course_details['course_type'] == 'general') : ?>
                                    <li class="text-white"><img class="me-2" src="<?= base_url() ?>uploads/system/sheck-type.png" alt="">Clase virtual en
                                        vivo, junto al docente</li>
                                    <li class="text-white"><img class="me-2" src="<?= base_url() ?>uploads/system/sheck-type.png" alt="">Acceso al software
                                        BIMDev 2023
                                    </li>
                                ...
                                <?php endif; ?>
                                <li class="text-white"><img class="me-2" src="<?= base_url() ?>uploads/system/sheck-type.png" alt="">Acceso a comunidad
                                    exclusiva
                                </li>
                                ...
                                <li class="text-white"><img class="me-2" src="<?= base_url() ?>uploads/system/sheck-type.png" alt="">Certificado por
                                    ...
                                    <div class="d-flex flex-row mb-3 align-items-center justify-content-center fondo-dm">
                                        <div class="p-2"> <a href="#"> <img src="<?= base_url() ?>uploads/system/descargar-manual.png " alt=""></a></div>
